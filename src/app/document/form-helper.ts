...
import { CroquisComponent } from 'app/document/form/controls/croquis/croquis.component';
import { DetalleComponent } from 'app/document/form/controls/detalle/detalle.component';
import { DisponibilidadComponent } from 'app/document/form/controls/disponibilidad/disponibilidad.component';
import { FechaComponent } from 'app/document/form/controls/fecha/fecha.component';
import { GpsComponent } from 'app/document/form/controls/gps/gps.component';
import { GpsMapComponent } from 'app/document/form/controls/gps-map/gps-map.component';
import { InformativeComponent } from 'app/document/form/controls/informative/informative.component';
import { NumeroComponent } from 'app/document/form/controls/numero/numero.component';
import { ProcesoComponent } from 'app/document/form/controls/proceso/proceso.component';
import { ProductoListaComponent } from 'app/document/form/controls/producto-lista/producto-lista.component';
import { SeccionComponent } from 'app/document/form/controls/seccion/seccion.component';
import { TextoComponent } from 'app/document/form/controls/texto/texto.component';
import { VinculoComponent } from 'app/document/form/controls/vinculo/vinculo.component';
