import { ArchivoComponent } from 'app/modules/admin/apps/bpm/form/controls/archivo/archivo.component';
import { BinarioComponent } from 'app/modules/admin/apps/bpm/form/controls/binario/binario.component';
import { CroquisComponent } from 'app/modules/admin/apps/bpm/form/controls/croquis/croquis.component';
import { FechaComponent } from 'app/modules/admin/apps/bpm/form/controls/fecha/fecha.component';
import { NumeroComponent } from '../form/controls/numero/numero.component';
import { DetalleComponent } from 'app/modules/admin/apps/bpm/form/controls/detalle/detalle.component';
import { ProcesoComponent } from 'app/modules/admin/apps/bpm/form/controls/proceso/proceso.component';
import { SeccionComponent } from 'app/modules/admin/apps/bpm/form/controls/seccion/seccion.component';
import { TextoComponent } from 'app/modules/admin/apps/bpm/form/controls/texto/texto.component';
import { ConfiguracionComponent } from 'app/modules/admin/apps/bpm/form/controls/configuracion/configuracion.component';
import { DisponibilidadComponent } from 'app/modules/admin/apps/bpm/form/controls/disponibilidad/disponibilidad.component';
...
import { ProductoListaComponent } from 'app/modules/admin/apps/bpm/form/controls/producto-lista/producto-lista.component';
import { GpsComponent } from 'app/modules/admin/apps/bpm/form/controls/gps/gps.component';
