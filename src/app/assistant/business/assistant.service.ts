...
import { AssistantIntent, AssistantMessage, AssistantResult, ChatMessage, CreateDocumentAction, DocumentActionField, DocumentSearchResult, TemplateSearchResult } from '../domain/assistant.models';
