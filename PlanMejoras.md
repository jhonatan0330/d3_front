...
- [x] **P1-1** 5 componentes OnPush mutan props planas en subscribes sin CDR: `form.component.ts`, `massive.component.ts`, `cruds2.component.ts`, `security.component.ts`. Convertir estado a signals. *(Hecho: `security` + `cruds2` en commit P1-1a. Pendiente: `massive` y `form`.)*
